	...
	<div class="row">
        ...
        {{csrf_field()}}
            ...
            <div class="form-group">
            	...
            	<input type="text" name="contacto" class="form-control" value="{{$ruta->contacto}}" placeholder="contacto...">
            </div>
	                   <div class="form-group">
            	<label for="descripcion">Telefono</label>
            	<input type="text" name="telefono" class="form-control" value="{{$ruta->telefono}}" placeholder="telefono...">
            </div>   
		</div>
