...
<div class="invoice p-3 mb-3">
	<div class="row">
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
			<p>
				<b>Nks-Control</b> es un sistema desarrollado por la empresa <b>CORPORACION DE SISTEMAS NKS</b>, con el fin de brindar una 
		...
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
			<p align="center">
		<img src="{{asset('dist/img/logosistema.jpg')}}"  width="350" height="200" alt="User Image">
		</p>
		</div>
	</div>
	</div>
